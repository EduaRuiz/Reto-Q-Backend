...
import { ITestDomainService, IUserDomainService } from '@main-service/domain/services';
...
describe('FinishTestUseCase', () => {
    ...
    beforeEach(() => {
        ...
        useCase = new FinishTestUseCase(testService, userService, testFinishedDomainEvent);
    });
